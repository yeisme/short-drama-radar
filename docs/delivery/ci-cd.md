# Short-Drama Radar CI/CD

本项目采用根级 `docs|quick|full|integration|release` 语义，但 workflow、命令和证据由本仓库自己维护。Profile：`TypeScript/Bun CLI`。
...
No live-platform or automatic publish lane; normal CI stays fixture-only.
